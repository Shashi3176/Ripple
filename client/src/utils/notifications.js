...
export const getNotificationSettings = () => {
  try {
    const raw = localStorage.getItem("ripple-notification-settings");
...
export const saveNotificationSettings = (settings) => {
  try {
    localStorage.setItem("ripple-notification-settings", JSON.stringify(settings));
  } catch {}
  return settings;
};
